    ...
    public partial class Uslugi : Window
    {
        ...
        public void ShowTable(string sql)
        {
            ...
            while (reader.Read() && reader.HasRows)
            {
                ...
                {
                    ID_услуги = reader.GetInt32("ID_service"),
                    Название_услуги = reader.GetString("Name"),
                    Цена_услуги = reader.GetInt32("Price"),
                    Продолжительность_услуги = reader.GetString("TimeWork"),
                    Изображение_услуги = LoadImage("avares://Zhukov_Proizv_Pract2/Photos/" + reader.GetString("Picture")),
                   Изображение_услуги_путь = reader.GetString("Picture"),
                    Размер_скидки = reader.GetInt32("Discont"),
                    Цена_со_скидкой = reader.GetInt32("Price") - (reader.GetInt32("Price") * reader.GetInt32("Discont") / 100)
                };
                _services.Add(Serv);
            }
      ...
      private void DiscountFilter(object? sender, SelectionChangedEventArgs e)
        ...
        private void DeleteData(object? sender, RoutedEventArgs e)
        {
            try
            {
                ...
                conn = new MySqlConnection(connStr);
                conn.Open();
                string sql = "DELETE FROM Service WHERE ID_service = " + srv.ID_услуги;
